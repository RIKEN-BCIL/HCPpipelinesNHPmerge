...
- All data were preprocessed with the HCP pipeline. For rhesus macaque, 
  ...
  and mid-point warping was applied to the non-flipped data. Metrics of 
  templates (sulci in surface and T1w and T2w signals in volume) were not
  averaged across left-right.
